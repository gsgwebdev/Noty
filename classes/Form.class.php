...
class Form {
  ...
  public function setErrors($fieldsErr) {
    foreach ($fieldsErr as $field=>$err) {
      $this->fieldsErr[$field] = $err;
    }
  }

  public function setValid($validFields) {
    foreach ($validFields as $field=>$result) {
      $this->validFields[$field] = $result;
    }
  }
